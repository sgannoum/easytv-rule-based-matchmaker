...
public class UserTest {
	...
	"[font_size_suggestion:" + 
			...
			"->" + 
			"	(?sugPref http://www.owl-ontologies.com/OntologyEasyTV.owl#hasCSUITestSize '60'^^http://www.w3.org/2001/XMLSchema#int)" + 
	 "]";
	...
	public void TestUserInference1() 
	  throws JsonParseException, IOException, UserProfileParsingException {
		...
		Property hasAudioVolumeProperty = model.getProperty(OntPreference.hasCSAudioVolume);
	...
	public void TestUserInference3() 
	  throws JsonParseException, IOException, UserProfileParsingException {
		...
		Property hasBackgroundProperty = model.getProperty(OntPreference.hasDisplayCursorColor);
